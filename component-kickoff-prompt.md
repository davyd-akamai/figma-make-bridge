...
4. Add it to `src/App.tsx`'s preview harness in its own labeled section (see the existing sections for the pattern), demoing more than one meaningful state if the component has interactive variants.
